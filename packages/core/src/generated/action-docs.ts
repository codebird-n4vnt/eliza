...
export const allActionsSpec = {
	...
	actions: [
		...
		},
		{
			...
			descriptionCompressed:
				"Borrow tokens from Kamino Lend against existing deposited collateral. Use when user wants to take a loan, borrow an asset, or leverage their deposits...",
		},
		{
			name: "KAMINO_DEPOSIT",
			description:
			...
			descriptionCompressed:
				"Deposit tokens as collateral into Kamino lend. This enables borrowing against the deposited assets. Use when user wants to collateral before borrowing, or...",
		},
		{
			name: "KAMINO_HEALTH",
			description:
			...
			descriptionCompressed:
				"Check the health of your Kamino Lend positions across all markets. Shows deposits, borrows, health factor, borrow limit, and liquidation risk. Use when user...",
		},
		{
			name: "KAMINO_LEND",
			description:
			...
			descriptionCompressed:
				"Lend (pure supply) tokens into Kamino Lend to earn supply APY. This does NOT use the tokens as collateral for borrowing. Use when user wants to earn passive...",
		},
		{
			...
			descriptionCompressed:
				"Withdraw deposits from a lending position in Kamino. Use when user wants to exit their lending/supply position and reclaim their tokens plus earned interest.",
		},
		{
			name: "KAMINO_REPAY",
			description:
			...
			descriptionCompressed:
				"Repay borrowed debt in Kamino Lend. Use when user wants to pay back a loan, reduce their debt, or close a borrowing position partially or fully.",
		},
		{
			...
			descriptionCompressed:
				"List all available Kamino Lend reserves with current supply APY, borrow APY, LTV, and available liquidity. Use when user asks about lending rates, borrowing...",
		},
		{
			...
			descriptionCompressed:
				"Withdraw a lending deposit from Kamino. Use when user wants to exit their",
		},
		{
			name: "LINEAR",
			description:
