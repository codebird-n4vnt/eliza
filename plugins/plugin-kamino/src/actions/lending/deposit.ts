...
export const depositAction : Action = {
    ...
    examples: [
        [
            ...
            {name: '{{agentName}}', content:{text:'Successfully deposited 10 SOL collateral...' ,actions:['KAMINO_DEPOSIT']}},
        ],
        [
            {name: '{{user1}}', content:{text:'Add 500 USDC collateral'}},
            {name: '{{agentName}}', content:{text:'Successfully added 500 USDC as collateral...' ,actions:['KAMINO_DEPOSIT']}},
        ]
    ]
